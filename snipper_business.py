...
# --- CONFIGURATION ---
TELEGRAM_TOKEN = "8308685146:AAGBMJUQVQwSiDsJpL-UMT4nN-x9o6W4FoA"
CHAT_ID = "-1003676783470"
...
TARGETS = [
    ...
    },
    {
        ...
        "trigger_price": 1000,
        # Strict filter for expensive "Red Carpet" shoes only
    ...
    },
    {
        ...
        "trigger_price": 2000,
        # For Kilimall, we look for ANY high value item in the flash sale
...
# --- MAIN LOOP ---
print("🚀 TITANFLOW: STRICT MODE ACTIVE (Jumia + Kilimall)...")
